...
- **Language is still visual-only** (decision #5) — the list always shows English selected, nothing
  else is tappable. (The Notifications screen's "Sound & Vibration" toggle is a *different*
