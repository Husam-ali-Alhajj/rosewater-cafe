...
///
/// Deliberately leaves every accent gradient (`AppColors.primaryGradient`,
/// the membership tier gradients, `AppColors.bottomNavActive`) out of this --
/// Task 2 asks for those to be reused exactly as-is in both modes, not
/// retokenized, so the app still reads as Rosewater Café's pink/purple brand
/// at night rather than something re-skinned.
@immutable
